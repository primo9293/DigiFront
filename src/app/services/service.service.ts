...
let navigation: List[] = [
  { id: 1, text: "Products", icon: "product", url: "products" },
  { id: 2, text: "Sales", icon: "money", url: "" },
  { id: 3, text: "Customers", icon: "group", url: "" },
  { id: 4, text: "Employees", icon: "card", url: "" },
  { id: 5, text: "Reports", icon: "chart", url: "" }
];
